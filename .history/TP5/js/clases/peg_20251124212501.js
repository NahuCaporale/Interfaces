...
const rutasImagenes = {
  ...
  fichaNormal: "assets/peg/fichanormal.png",
  fichaEspecial: "assets/peg/fichaespecial.png",
  fondoTablero: "assets/peg/fondocometa.jpg",
  celda: "assets/peg/celda2.jpg",
};
...
async function iniciarJuego() {
  try {
    ...
    const [imgNormal, imgEspecial, imgFondo, imgCelda] = await Promise.all(
      promesas
    );
    ...
    if (gameController) {
      gameController.destroyListeners();
    }
    gameController = new GameController(canvas, board, vista);
