...
canvas.addEventListener('mousedown', on,Mousedown,false);
canvas.addEventListener('mouseup', on,Mouseup,false);
canvas.addEventListener('mousemove', on,Mousemove,false);
