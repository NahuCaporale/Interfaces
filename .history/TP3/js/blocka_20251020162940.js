...
startBtn.addEventListener("click", () => {
    // Ocultar botón y overlay
    startBtn.style.display = "none";
    const wrapper = document.querySelector(".canvas-wrapper");
    wrapper.querySelector("::after"); // pseudo-element no se manipula en JS, pero como el botón desaparece el overlay deja de ser útil
    wrapper.style.pointerEvents = "none"; // opcional: desactiva hover del overlay
