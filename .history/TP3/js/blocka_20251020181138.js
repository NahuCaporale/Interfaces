...
function dibujarPartes() {
    ...
    // Aplicar filtro después de dibujar todas las piezas
    if (nivelActual === 1) aplicarFiltro("grises");
    if (nivelActual === 2) aplicarFiltro("brillo");
    if (nivelActual === 3) aplicarFiltro("negativo");
}
