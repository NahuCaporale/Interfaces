...
const niveles = [
    { imagen: "./assets/imgs/avatar.jpg", filtro: "grayscale(100%)" },
    { imagen: "./assets/imgs/avatar1.png", filtro: "brightness(70%)" },
    { imagen: "./assets/imgs/avatar2.jpg", filtro: "invert(100%)" },
];
...
function iniciarNivel() {
    ...
    canvas.style.filter = nivel.filtro;

    desordenarPartes();
    dibujarPartes();
    startBtn.style.display = "block"; // volver a mostrar botón
    juegoIniciado = false;
    segundos = 0;
    timerDisplay.textContent = formatearTiempo(segundos);
}
...
function siguienteNivel() {
    ...
    if(nivelActual >= niveles.length) {
        ...
        nivelActual = 0; // o reiniciamos el juego
    } else {
        iniciarNivel();
    }
}
...
//desaparezco el boton de play cuando doy play 
startBtn.addEventListener("click", () => {
    // Ocultar el botón al hacer click
...
document.getElementById("restartBtn").addEventListener("click", () => {
    ...
    juegoIniciado = false;
    startBtn.style.display = "block"; // vuelve a aparecer
    segundos = 0;
    timerDisplay.textContent = formatearTiempo(segundos);
