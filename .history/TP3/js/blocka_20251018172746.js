...
const imgsGaleria = document.querySelectorAll("#galeriaSeleccion .galeria-img");
let indiceActual = 0;

function animarGaleria() {
    imgsGaleria.forEach(img => img.classList.remove("hovered"));
    imgsGaleria[indiceActual].classList.add("hovered");
    indiceActual = (indiceActual + 1) % imgsGaleria.length;
}

// Animación cada 500ms
setInterval(animarGaleria, 500);
